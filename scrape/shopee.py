...
def scrape_shopee(type, keyword):
    ...
    if type == "toko":
        ...
        results.append("Kualitas: bagus, pacing aman, kondisi barang sesuai deskripsi pesanan, responsif, semoga awet\nDesain: bagus dan menarik\nKeaslian: original")
    elif type == "produk":
